...
def main():
    while True:
        ...
        #Collecting user input and converting it to lower case.
...
#checking if the user wants to do another calculation.
        calc_again = input("Would you like to perform another calculation? (yes to continue, any key to exit): ").strip().lower()
        if calc_again != "yes":
            break
        
#function that calculates the bond.
def calculate_bond():
    try:
...
#function to calculate the investment
